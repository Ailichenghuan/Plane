...
public class Ticket extends JFrame implements  ActionListener{
	private static JLabel l1=new JLabel("航班编号");
	private static JLabel l2=new JLabel("预售");
	private static JLabel l3=new JLabel("身份证号");
	private static JLabel l4=new JLabel("价格");
	private static JLabel l5=new JLabel("折扣");
	private static JLabel l6=new JLabel("开售时间");
	...
	public static  void add(String x,String y,String x1,String y1,String x2,String y2){
		String sql="SELECT * FROM ticket WHERE 身份证号=?";
	String in="INSERT INTO ticket (航班编号,预售,身份证号,价格,折扣,开售时间)"+"VALUES (?,?,?,?,?,?);";
	String driver = "com.mysql.cj.jdbc.Driver";
	 String url ="jdbc:mysql://localhost:3306/airplane?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT&useSSL=false";
	 String user = "root";
	 String password = "liuyang"; if (x==null||x.equals("")||y==null||y.equals("")||x1==null||x1.equals("")||y1==null||y1.equals("")||x2==null||x2.equals("")||y2==null||y2.equals("")) {
...
try {
		...
		while(rs.next()){
			s1=rs.getString("航班编号");
			s2=rs.getString("预售");
			s3=rs.getString("身份证号");
			s4=rs.getString("价格");
			s5=rs.getString("折扣");
			s6=rs.getString("开售时间");
		}
 ...
 //查询
	public  void get(String s){
	 String sql="SELECT * FROM ticket WHERE 身份证号='"+s+"'";
	 if (s.equals("")) {
...
try {
	...
	public static  void update(String r1){//String r,String t,,String t1,String r2,String r3
		String sql="SELECT * FROM ticket WHERE 身份证号=?";
	String up="UPDATE ticket SET 航班编号='" + x1.getText() + "',预售='" + x2.getText() + "',价格='" + x4.getText() + "',折扣='" + x5.getText() + "',开售时间='" + x6.getText() + "' WHERE 身份证号='" + r1 + "'";
	String driver = "com.mysql.cj.jdbc.Driver";
	 String url ="jdbc:mysql://localhost:3306/airplane?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false";
	 String user = "root";
	 String password = "liuyang";
...
//删除
	public static  void del(String r){
		String sql="SELECT * FROM ticket WHERE 身份证号=?";
	String up="DELETE FROM  ticket  WHERE 身份证号=?";
	String driver = "com.mysql.cj.jdbc.Driver";
	 String url ="jdbc:mysql://localhost:3306/airplane?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT&useSSL=false";
	 String user = "root";
	 String password = "liuyang";
